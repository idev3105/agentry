        ...
        >
            ...
            <div class="max-h-96 overflow-y-auto py-1">
                ...
                {#each groups as [cat, items] (cat)}
                    <div
                        class="px-3 pt-2 pb-1 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground"
                    >
                        {cat}
                    </div>
                    {#each items as item (item.id)}
                        ...
                        >
                            ...
                            {#if item.shortcut}
                                <kbd
                                    class="px-1.5 py-0.5 rounded bg-background text-foreground text-[10px] font-mono border border-border"
                                >
            ...
            <div
                class="px-3 py-1.5 border-t border-border flex items-center gap-3 text-[10px] text-muted-foreground"
            >
                <span
                    ><kbd class="font-mono text-foreground">↑↓</kbd> navigate</span
                >
                <span
                    ><kbd class="font-mono text-foreground">↵</kbd> select</span
                >
                <span
                    ><kbd class="font-mono text-foreground">Esc</kbd> close</span
                >
            </div>
        </div>
    </div>
